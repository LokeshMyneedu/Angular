...
export class EventService {
  ...
  constructor(private http:HttpClient) {
    ...
    getEvents():Observable<IEvent[]>{
       return this.http.get<IEvent[]>('/api/events').pipe(catchError(this.hadleError<IEvent[]>('getEvents',[])))
    ...
    getEvent(id:number):Observable<IEvent>{
      return this.http.get<IEvent>('/api/events/'+id).pipe(catchError(this.hadleError<IEvent>('getEvent')))
    }

    saveEvent(event):Observable<IEvent>{
      let options ={headers: new HttpHeaders({'Content-Type':'application/json'})};
      return this.http.post<IEvent>('api/events',event,options).pipe(catchError(this.hadleError<IEvent>('saveEvent')))
    }
   ...
   /*  updateEvent(event){
    ...
    searchSessions(searchTerm:string):Observable<ISession[]>{
      return this.http.get<ISession[]>('/api/sessions/search?search='+searchTerm).pipe(catchError(this.hadleError<ISession[]>('searchSessions')));
